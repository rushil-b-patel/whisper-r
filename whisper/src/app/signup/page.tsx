        ...
        <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm p-6 mb-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <div className="flex">
                <span className="inline-flex items-center px-3 bg-gray-100 dark:bg-gray-700 border border-r-0 border-gray-300 dark:border-gray-700 rounded-l-lg text-gray-500 dark:text-gray-400 text-sm">
                  u/
                </span>
                <input
                  id="username"
                  ...
                  className="w-full px-3.5 py-2.5 border border-gray-300 dark:border-gray-700 rounded-r-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 dark:bg-gray-800 dark:text-white"
